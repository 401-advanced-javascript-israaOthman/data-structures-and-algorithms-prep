...
Write a function named templatingWithMustache that uses mustache to create the markup templates 
for each of the characters. Use the snippet as your guide for creating your templates.
...
const houseSize = (arr) => {
    ...
    arr.forEach(val => {
      ...
      let house = {house : names[3] , members : counter }
      sizes.push(house);
    });
