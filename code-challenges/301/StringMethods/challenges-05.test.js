...
// to learn more about the cheerio library and what it is doing, 
// look at their documentation: https://www.npmjs.com/package/cheerio
...
const templateWithJQuery = () => {
    starWarsPeople.forEach((val,idx) =>{
        ...
        temp.removeAttr('id');
        temp.find('h2').text(val.name);
        temp.find('h3').text(val.height);
        temp.find('p').text(val.eye_color);
...
Write a function named howMuchPencil that takes in a string, 
as written on the side of a pencil.
