...
Connect a '/aboutme' route that sends a short bio about you to the front-end.
 Finally, connect a '/favoritefoods' route that sends an array to the front-end of your favorite foods.
...
app.get('/aboutme',(req,res)=>{
    res.status(200).send('My name is Israa Othman and I\'m 23 years old');
})
app.get('/favoritefoods',(req,res)=>{
    res.status(200).send('My Fav Food are : 1- Shawerma 2- Maqloba 3-Msa5an ');
})
